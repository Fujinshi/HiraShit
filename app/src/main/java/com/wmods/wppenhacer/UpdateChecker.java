...
public class UpdateChecker implements Runnable {
    ...
    private static final String LATEST_RELEASE_API = "https://api.github.com/repos/Fujinshi/HiraShit/releases/latest";
    private static final String RELEASE_TAG_PREFIX = "debug-";
    private static final String TELEGRAM_UPDATE_URL = "https://t.me/Hirakox";
